...
(CASE 
WHEN reto4_usuario.usuario IN (SELECT reto4_profesor.usuario FROM reto4_profesor) THEN UPPER(reto4_profesor.nombre||" "||reto4_profesor.apellido)
WHEN reto4_usuario.usuario IN (SELECT reto4_estudiante.usuario FROM reto4_estudiante) THEN UPPER(reto4_estudiante.nombre||" "||reto4_estudiante.apellido)
